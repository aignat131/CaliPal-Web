...
import { ArrowLeft, Plus, Trash2, Pencil, Check, X, MapPin, Trophy, Users, Shield, ChevronDown, ChevronUp, BadgeCheck, Dumbbell, MessageSquare, Send, ChevronRight, Globe } from 'lucide-react'
...
type AdminTab = 'parks' | 'challenges' | 'communities' | 'park_requests' | 'verifications' | 'exercises' | 'feedback'

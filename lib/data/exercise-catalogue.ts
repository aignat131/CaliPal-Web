...
export const DEFAULT_EXERCISE_CATALOGUE: CatalogueEntry[] = [
  ...
  // ── Cu Bandă ──────────────────────────────────────────────────────────────────
  { name: 'Tracțiuni cu bandă',       category: 'Cu Bandă',    metric: 'reps' },
  { name: 'Chin-up cu bandă',         category: 'Cu Bandă',    metric: 'reps' },
  { name: 'Australian Pull-up bandă', category: 'Cu Bandă',    metric: 'reps' },
  { name: 'Flotări cu bandă',         category: 'Cu Bandă',    metric: 'reps' },
  { name: 'Dips cu bandă',            category: 'Cu Bandă',    metric: 'reps' },
  { name: 'Squaturi cu bandă',        category: 'Cu Bandă',    metric: 'reps' },
  { name: 'Lunges cu bandă',          category: 'Cu Bandă',    metric: 'reps' },
  { name: 'Glute Bridge cu bandă',    category: 'Cu Bandă',    metric: 'reps' },
  { name: 'Face Pull cu bandă',       category: 'Cu Bandă',    metric: 'reps' },
